# home.py - RESPONSIVE MOBILE + PC ✅ DARK/LIGHT ✅ SIDEBAR INVISIBLE
...
<style>
    ...
    @media (min-width: 769px) and (max-width: 1200px) {
        /* ✅ 2 COLONNES TABLETTE */
        .tool-card, .soon-card { height: 220px !important; padding: 2rem 1.2rem !important; }
    ...
    @media (min-width: 1201px) {
        .tool-card, .soon-card { height: 240px !important; }
    }
</style>
...
.tool-card { color: var(--text-primary) !important; padding: 2.5rem 1.5rem !important; border-radius: 24px !important; text-align: center !important; border: 2px solid var(--border-color) !important; margin: 1rem 0.5rem !important; height: 240px; display: flex; flex-direction: column; justify-content: center; transition: all 0.3s ease !important; position: relative; overflow: hidden; backdrop-filter: blur(20px) !important; }
.tool-card:hover { transform: translateY(-10px) scale(1.02) !important; border-color: var(--accent-color) !important; }
.soon-card { padding: 2.5rem 1.5rem !important; border-radius: 24px !important; text-align: center !important; margin: 1rem 0.5rem !important; height: 240px; display: flex; flex-direction: column; justify-content: center; animation: pulse 2s infinite; }
